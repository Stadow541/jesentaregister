...
exports.run = async (client, message, args) => {
    ...
    if(!message.member.roles.cache.some(r => ["775755714202435664"].includes(r.id)) && (!message.member.hasPermission("ADMINISTRATOR")))
...
.setFooter(`TANRISIZ 💛 RİWU`) // evet bilerek kaldırmadım ayriyetten sıfırdan yazdım :)
