...
exports.run = async (client, message, args) => {
 ...
 if(!['775755715792339005'].some(role => message.member.roles.cache.get(role)) && !message.member.hasPermission('ADMINISTRATOR')) return message.reply(`Bu Komut İçin Yetkiniz Bulunmamaktadır.`) 
  
let tag = "ꏙ"
const kayıtlı = message.guild.roles.cache.find(r => r.id === '775755720313929768')
const kayıtsız = message.guild.roles.cache.find(r => r.id === '775755722352361483')
...
.setFooter(`Tanrısız #Code`)
.setColor('GREEN')
client.channels.cache.get('775755814177996841').send(embed)
